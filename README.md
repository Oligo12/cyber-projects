...
- [**legacy-sentinel-ir-lab/**](legacy-sentinel-lab) - Foundational Microsoft Sentinel lab (architecture + detections). The associated IR case study is in [**incident-response/**](/incident-response).
