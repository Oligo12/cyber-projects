...
- [**edr-project/**](/edr-project) - custom mini EDR prototype using kernel callbacks and userland API hooks to detect process injection (process hollowing, shellcode injection). Validated against real malware (SnakeKeylogger).
